...
Для одного реального прогона после входа используйте `-google-auth-run -env prod-holding`: режим всегда без записи, после расчёта HTTP остаётся работающим. Настройки Render — в разделе 8 инструкции.
