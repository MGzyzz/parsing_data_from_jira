...
Пошаговая проверка на бесплатном Render без Docker — в разделе «Проверка prod-holding на Render Free без Docker» ниже.
...
хранилище токенов пока не реализовано.
